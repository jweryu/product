...
public class MailUtil {
        ...
        static String from = "测试用例";

        static String user = "1689449711@qq.com";
        static String password = "woshinibaba1111";
        ...
        public static void main(String args[]) throws IOException
        {
            ...
            String path=ReadHTML.reMailString("buff_path");
            MailUtil.sendEmail("3430198340@qq.com", "测试", path);
