...
public class WebTestListener extends TestListenerAdapter {
    ...
    public void onFinish(ITestContext testContext) {
        ...
        if(BasePrepare.getCfgProperty("enable_email").equals("true"))
        {
            String emailContent=this.writeResultToMailTemplate();
            String emailTitle=BasePrepare.getCfgProperty("mail_title")+"----"+this.getTime();
            String toMail=BasePrepare.getCfgProperty("to_mail");
            try {
                ...
                {
                    MailUtil.sendEmail(BasePrepare.getCfgProperty("success_to_mail"),emailTitle, emailContent);
                    Log.info("email send to "+BasePrepare.getCfgProperty("success_to_mail")+" success");
                }
